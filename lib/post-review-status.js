...
async function main() {
    ...
    const contextName = core.getInput("context") || github_1.context.repo.repo;
    ...
    return github.rest.repos.createCommitStatus({
        ...
        description: `status of ${github_1.context.repo.owner}/${contextName}#${github_1.context.payload.pull_request.number}`,
